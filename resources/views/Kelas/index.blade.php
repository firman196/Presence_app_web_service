            ...
            <form id="form-data" action="#" method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="nama_kelas" class="form-control-label">Nama Kelas <span style="color: red">*</span></label>
                    <input id="nama-kelas" name="nama_kelas" type="text" placeholder="masukkan nama kelas" class="form-control">
                    <span><small class="text-danger nama-kelas-error" id="nama-kelas-error"></small></span>
                  </div>
                </div>
                            ...
                            $.ajax({
                                  ...
                                  success : function(data){
                                    if(JSON.parse(data.meta.code) == 200){
                                        $('#Modal').modal('hide');
                                        swal.fire("Selesai","Kelas berhasil ditambahkan","success").then((val)=>{
                                          location.reload();
                                        });
                                    }
                                  },
                      ...
                      $('#dataTable tbody').on('click', '.hapus', function () {
                          ...
                          $.ajax({
                                    ...
                                    success : function(data){
                                      if(JSON.parse(data.meta.code) == 200){
                                            $('#Modal').modal('hide');
                                            swal.fire("Selesai","Kelas berhasil dihapus","success").then((val)=>{
                                              location.reload();
                                            });
                                      }
                                    },
