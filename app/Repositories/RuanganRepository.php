...
class RuanganRepository {
    ...
    public function withProdi() {
        $datas = $this->model->with(['prodi'])->get();
        return $datas;
    }

    public function withBeacon() {
        $datas = $this->model->with(['beacon'])->get();
        return $datas;
    }
    ...
    public function findBy(array $where) {
        $datas = $this->model->where($where)->with(['prodi'])->first();
        return $datas;
    }
